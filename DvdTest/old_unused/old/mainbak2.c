...
{
//	int nRet = DVD_WriteDriveMemDword(0x8000, GC_Rand());
//	g_nLBA = nRet;
...
/*	DEBUG_ShowValueU32(70,	60,	dvd[0]);	// DVD_Status1()
	...
	DEBUG_ShowValueU32(490, 60, dvd[7]);	// R_DVD_COMMAND R_DVD_ERRORCODE
	
	DEBUG_ShowValueU32(70,	80,	R_DVD_ERRORCODE);
	DEBUG_ShowValueU32(210, 80, dvd[2]);
	DEBUG_ShowValueU32(350, 80, dvd[8]);
	DEBUG_ShowValueU32(490, 80, dvd[9]);
*/
		...
		//-------------------------------------------------
			...
			if(g_nKey & PAD_A) {
				...
				//---------------------------------------------------
					...
					GC_Memory_memset((void*)g_pBuffer, 0xAA, 2048);
